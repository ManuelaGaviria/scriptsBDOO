...
CREATE TABLE NOTAS (
    ...
    CONSTRAINT PK_NOTA PRIMARY KEY (ID_EXAMEN, DNI_ESTUDIANTE),
    CONSTRAINT FK_DNI_ESTUDIANTE_NOTAS FOREIGN KEY (DNI_ESTUDIANTE) REFERENCES USUARIOS(DNI_USU),
