-- DROP TABLES (ordenados según dependencias)
--DROP TABLE EXAMENES_ORALES_PRESENTADOS;
--DROP TABLE EXAMENES_ESCRITOS_PRESENTADOS;
DROP TABLE EXAMENES_ESCRITOS_NESTED_TABLE;
DROP TABLE EXAMENES_ORALES_NESTED_TABLE;
DROP TABLE EXAMENES_NESTED_TABLE;
DROP TABLE CLASES_NESTED_TABLE;
...
-- DROP NESTED TABLE OBJECTS (si existen)
DROP TABLE ESTUDIANTES_NESTED_TABLE;
DROP TABLE RESPUESTAS_NESTED_TABLE;
DROP TABLE PREGUNTAS_NESTED_TABLE;
...
-- DROP OBJECTOS ANIDADOS Y TIPOS DE USUARIOS
...
CREATE OR REPLACE TYPE EXAMEN_ESCRITO AS OBJECT (
    ...
    PREGUNTAS PREGUNTAS_TBL
);
/

--Tabla examenes escritos
CREATE TABLE EXAMENES_ESCRITOS OF EXAMEN_ESCRITO(
	CONSTRAINT PK_EXAMEN_ESCRITO PRIMARY KEY (CODIGO_EXAMEN_ESCRITO)
) NESTED TABLE PREGUNTAS STORE AS PREGUNTAS_NESTED_TABLE TABLESPACE ts_bdobjectual;
...
CREATE TABLE NIVELES_OBJ OF NIVEL (
    CONSTRAINT PK_NIVEL PRIMARY KEY (CODIGO_NIVEL)
) TABLESPACE ts_bdobjectual;
